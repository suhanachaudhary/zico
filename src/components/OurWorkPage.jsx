    ...
    return (
        <div className="bg-[#111] text-white py-36 px-6 md:px-16">
            ...
            <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-gray-400 mb-4">Know more:</p>
                <p className="text-gray-300">Address: H-10, Raghav Puram, Saharanpur, 247001, India</p>
                <p className="text-gray-300">Phone: +91 9286182820 / +44 7879953499 (WhatsApp)</p>
                <p className="text-gray-300">Emails: <a href="mailto:Hastinapurstudio@gmail.com" className="text-[#D39D55] hover:underline">Hastinapurstudio@gmail.com</a> / <a href="mailto:akaniket10@gmail.com" className="text-[#D39D55] hover:underline">akaniket10@gmail.com</a></p>
                <p className="text-gray-300">LinkedIn: <a href="https://linkedin.com/in/aniket10021" target="_blank" rel="noopener noreferrer" className="text-[#D39D55] hover:underline">linkedin.com/in/aniket10021</a></p>
            </div>
        </div>
    );
};
