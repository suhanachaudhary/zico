        ...
        <div className="min-h-screen bg-gradient-to-b from-[#070707] via-[#0b0b0b] to-[#111] text-white py-36 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <p className="text-[#D39D55] uppercase tracking-widest text-xl mb-2">About Us</p>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-16">
                    <blockquote className="bg-black/60 p-6 rounded-lg border border-white/5 shadow-sm">
                        <p className="text-[#D39D55] text-lg font-semibold mb-3">“At Hastinapur Studio, we don’t just make films—we bring alive the soul of a civilization.”</p>
                        <p className="text-lg text-gray-300">Turning timeless stories into cinematic journeys that echo across the world.</p>
                    </blockquote>

                    <blockquote className="bg-black/60 p-6 rounded-lg border border-white/5 shadow-sm">
                        <p className="text-[#D39D55] text-lg font-semibold mb-3">“We craft worlds, preserve heritage, and inspire generations.”</p>
                        <p className="text-lg text-gray-300">Stories that connect the past, present and future.</p>
                    </blockquote>

                    <blockquote className="bg-black/60 p-6 rounded-lg border border-white/5 shadow-sm">
                        <p className="text-[#D39D55] text-lg font-semibold mb-3">“Our cinema speaks the language of the heart.”</p>
                        <p className="text-lg text-gray-300">From the epics of the past to the visions of tomorrow.</p>
                    </blockquote>
                </div>
                ...
                <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-300 text-lg">If you have a story, idea or partnership in mind, we'd love to hear from you.</p>
                    </div>
                    <div>
                        <Link
                            to="/contact"
